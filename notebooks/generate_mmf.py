...
mmf = MultiModalFlowBridge.load_from_checkpoint(f"/home/df630/Multimodal-flows/jet_sequences/{config.experiment_id}/checkpoints/best.ckpt")
...
gauss_noise = torch.randn_like(test.continuous)
cat_noise = torch.randint_like(test.discrete, mmf.vocab_size)
